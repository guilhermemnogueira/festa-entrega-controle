...
const SEED: Omit<Cliente, "id">[] = [
  { nome: "Ana Souza", sexo: "Feminino", nascimento: "1992-05-14", bairro: "Centro", telefone: "(11) 98888-1010", tipo: "Compra", comprou: "2 caixas de cerveja Heineken", alugou: "", valor: 320, pagamento: "PIX", motivo: "Churrasco de aniversário", modalidade: "Entrega", endereco: "Rua A, 100", dataPedido: monthDay(0, 3), mesRef: monthRef(0), observacoes: "Cliente VIP", status: "Concluído" },
  { nome: "Bruno Lima", sexo: "Masculino", nascimento: "1988-11-02", bairro: "Vila Mariana", telefone: "(11) 97777-2020", tipo: "Locacao", comprou: "", alugou: "10 cadeiras, 2 mesas", valor: 180, pagamento: "Dinheiro", motivo: "Festa junina", modalidade: "Retirada", dataPedido: monthDay(0, 8), mesRef: monthRef(0), status: "Pedido Realizado" },
  { nome: "Carla Mendes", sexo: "Feminino", nascimento: "1995-07-20", bairro: "Moema", telefone: "(11) 96666-3030", tipo: "Ambos", comprou: "1 caixa de vinho", alugou: "1 cooler grande", valor: 540, pagamento: "Cartão de crédito", motivo: "Casamento", modalidade: "Entrega", endereco: "Av. B, 250", dataPedido: monthDay(0, 12), mesRef: monthRef(0), status: "Em Entrega / Retirada" },
  { nome: "Diego Ferreira", sexo: "Masculino", nascimento: "1990-03-09", bairro: "Pinheiros", telefone: "(11) 95555-4040", tipo: "Compra", comprou: "3 caixas de cerveja, 4 refrigerantes", alugou: "", valor: 410, pagamento: "PIX", motivo: "Confraternização", modalidade: "Retirada", dataPedido: monthDay(0, 15), mesRef: monthRef(0), status: "Novo Contato" },
  { nome: "Eduarda Rocha", sexo: "Feminino", nascimento: "1985-09-25", bairro: "Centro", telefone: "(11) 94444-5050", tipo: "Locacao", comprou: "", alugou: "20 cadeiras, 5 mesas, 1 tenda", valor: 720, pagamento: "Fiado", motivo: "Aniversário infantil", modalidade: "Entrega", endereco: "Rua C, 88", dataPedido: monthDay(0, 18), mesRef: monthRef(0), status: "Recorrente" },
  ...
  { nome: "Lucas Martins", sexo: "Masculino", nascimento: "1994-02-28", bairro: "Vila Mariana", telefone: "(11) 96767-5432", tipo: "Locacao", comprou: "", alugou: "2 coolers, 1 caixa de som", valor: 230, pagamento: "Dinheiro", motivo: "Churrasco de aniversário", modalidade: "Retirada", dataPedido: monthDay(0, 20), mesRef: monthRef(0), status: "Pedido Realizado" },
];
...
function monthDay(offset: number, day: number) {
  const d = new Date();
  d.setMonth(d.getMonth() + offset);
  d.setDate(day);
